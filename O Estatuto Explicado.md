...
O texto a seguir deve ser tratado como um material de apoio para analise da a Lei 15.378/2026, o chamado "Estatuto do Paciente". Não é uma transcrição formal e neutra da lei, mas sim uma leitura comentada, no qual utilizarei tons críticos, comparativos e estilo informal, intercalando a reprodução de artigos com observações pessoais, de forma que sugiro a leitura acompanhada da lei em questão. Vale Ressaltar que a presente lei **NÃO** exclui ou inibi a aplicação das resoluções das categorias (CFM), apenas limita caso ela venha a ser contraria a lei.

Além disto, serão apontadas lacunas e comparações da lei brasileira com ordenamentos estrangeiros (Holanda, Portugal, EUA), mas não se pode afirmar que o texto abrange todos os pontos e questionamentos, estando passível de erros. 

O texto é estruturado, a princípio, em Capítulos 1, 2 e 3 de forma similar a lei, seguido de "Recomendações aos profissionais de saúde". Em caráter complementar, há os capítulos de Críticas, "Alta Voluntária" em especifico e uma tabela de resumo sobre cada capítulo ao final.
Dito isso:
...
- Nomenclaturas orientadoras da lei (art 2°)
	...
	5. Cuidados Paliativos
		- Não visa o prolongamento, nem o encurtamento da vida do paciente. Apenas permitir que ele siga o seu curso natural da forma mais digna e com a melhor qualidade de vida possível (seja em direção a morte ou não, a pedido do paciente ou do médico)
		- Descrição Conservadora, quando comparado com a da OMS

> **Observação!!** - Os cuidados paliativos não podem ser rejeitados pela *FAMÍLIA*, é um direito exclusivo do paciente, sendo a família dotada do direito de ser apoiada e assistida, mas não de escolher como o paciente será tratado. 
> Representante ≠ Familiar

>**Observação 2!!** - A forma como o representante é tratado pela lei difere do entendimento das resoluções: 
>> CFM: Caso um representante seja designado, suas informações serão levadas em consideração pelo médico
>> Lei 13.378: O Paciente tem direito de indicar livremente um representante para decidir por ele os cuidados caso este não consiga faze-lo
>>-Diferença: Considerar X Decidir por ele
>>- É uma ampliação da autonomia
<br>
- A lei rege todas as pessoas que trabalham com o objeto tutelado (saúde) e que possuem um relacionamento com o seu cliente na posição de paciente. Ou seja, não é apenas para os médicos, mas também para os planos de saúde, enfermeiros etc.
<br>
- ATENÇÃO: Art. 4°. A aplicação desta Lei não afasta os direitos do paciente ao adquirir ou utilizar produto ou serviço como destinatário final.
	- O Código de ética médica tenta afastar a relação consumerista, mas em geral, há sim a caracterização de uma relação de consumidor, não pelo enquadramento de uma mercadoria, mas sim pelo mérito de salva-guardar os direitos da parte vulnerável
<br>
...
> → **ISSO INCLUI MENORES DE IDADE?**
>> a jurisprudência brasileira irá dizer que este menor deve ter os seus interesses considerados, portanto, a mesma lógica se mantém.
<br>
- A diretiva de vontade **NÃO** é um documento de recusa terapêutica. Ela tem uma abrangência muito maior, definindo, até mesmo, quem é o paciente, a situação na qual ele se encontra, valores e interesses.
...
- **Art 6°:** Liberdade de escolha de um representante a qualquer momento, via registro em prontuário.
	- Flexibilização da representação já presente no CFM, visa o paciente que teve a sua situação física alterada, por qualquer motivo, e que agora deseja um representante para atuar em seu nome, que deseja alterar o seu representante ou retirar os poderes do mesmo.
...
>→ Visa garantir o direito à segurança geral do paciente em todos os sentidos e o direito de questionar sobre o procedimento, seja sobre ambiente, seja sobre os insumos, seja os médicos encarregados. Assim como gera o dever do médico de responder honestamente aos questionamentos, compreendendo que o paciente carece dos conhecimentos portados pelo profissional. 
...
- **Arts 11 ao 18 (direitos gerais)**
	...
	- → Privacidade
		...
		- *Quanto aos hospitais universitários, podem rejeitar paciente devido ao caráter discente? (polêmico para os médico)*
...
<br>
5. **Seguro de responsabilidade civil médica** vai se tornando cada vez mais similar aos EUA
<br>
6. **Trabalho em equipe documentado**
>Registrar encaminhamentos
>Identificar responsável pelo caso

7. **Principais riscos para médicos** (para processos)
	→ falta de informação
...
Por fim, apesar de ser uma lei nova, seu conteúdo é comparável ao que países como Holanda e EUA já consolidavam há décadas, o que evidencia o atraso histórico do Brasil nessa matéria e a necessidade de avanços complementares.
...
| •   | Cuidados paliativos                  |
| •   | Direitos do consumidor não afastados |
...
| •   | Representante por registro em prontuário                |
| --- | ------------------------------------------------------- |
| •   | Direito a acompanhante                                  |
| •   | Informação plena e acessível                            |
| •   | Recusa e retirada do consentimento                      |
| •   | Prontuário sem custo (art. 19)                          |
| •   | Respeito incondicional às diretivas (art. 20)           |
| •   | Cuidado paliativo + escolha do local da morte (art. 21) |

---

### Cap. III — Responsabilidades
*Arts. 22, 24*

| •   | Dever de compartilhar informações clínicas     |
| --- | ---------------------------------------------- |
| •   | Seguir orientações do profissional             |
| •   | Guardar cópia das diretivas                    |
| •   | Informar desistência do tratamento             |
| •   | Violação = ofensa a direitos humanos (art. 24) |

---

### Principais Lacunas

| •   | Sem prazo para entrega do prontuário   |
| --- | -------------------------------------- |
| •   | Sem registro nacional de diretivas     |
| •   | Ausência do direito à não informação   |
| •   | Alta voluntária sem regulação expressa |
| •   | Paliativos sem protocolo detalhado     |

---

### Medidas Práticas para Médicos

| •   | Documentação rigorosa com assinatura do paciente |
| --- | ------------------------------------------------ |
| •   | Templates por procedimento                       |
| •   | Diretivas anexadas ao prontuário                 |
| •   | Sigilo reforçado                                 |
